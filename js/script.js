...
const commands = {
	...
	{
		cmd: 'members',
		res: 'Artificial Angels Members:<span class="red"></span><br>0<span class="red"> wm3ryfxwz8o</span><br>1 <span class="red"> unavailable</span><br>2 <span class="red"> unavailable</span><br>3 <span class="red"> unavailable</span><br>4 <span class="red"> unavailable</span><br>'
	},
	aboutme:  
	{
		cmd: 'aboutme',
		res: 'About Me:<br># <span class="red">Real Name:</span> u thought lol... <br>'
	},
	links: 
	{
		cmd: 'links',
	...
	{
		cmd: 'help',
		res: 'Available commands:<br><br># <span class="red">aboutme</span> - Some information about me.<br># <span class="red">clear</span> - Really, it just clear. <br># <span class="red">screenfetch</span> - Fetches system information in the terminal.<br># <span class="red">links</span> - Links for others sites.<br># <span class="red">visitors</span> - How many times people visited this site.<br># <span class="red">insta [Link]</span> - Get original instagram picture.<br># <span class="red">members</span> - Shows all current artifical angels members.'
	}
}

var prephraseRoot = '<span class="red">root@xxyoxwx</span>:<span class="blue">~</span># ';
var prephrase = '<span class="red">visitor@rudeware.user</span>:<span class="blue">~</span># ';
...
{
	var res = '';
	if (command === './welcome.sh') res = 'Welcome to <span class="red">rudeware.cc</span>!<br></span><br>Made By:</span><span class="red"> wm3ryfxwz8o</span><br>Total Visits: <span class="red">' + visits + '</span><br>Terminal Updated: <span class="red">' + lastUpdate +'</span><br><br><b>Type \'help\' for more details on the commands</b>'
	else
	{
		window.alert("Nice try to changing \'root\' variable to 1");
		window.location = "https://youtu.be/5ngWIDkPP3o?t=78";
...
$('form').on('submit', function(e) {
	...
	try {
			...
			if (vInput.startsWith("./")) {
				if (vInput === "./root/welcome.sh") {
					...
					launchCommandAsVisitor({
						cmd: vInput,
						res: '<div><p>rudeware.cc: ' + vInput + ': No such file or directory</p></div>'
					});
				}
				...
				if (typeof loginArray[2] !== "undefined") {
					if (loginArray[2] === "visitor") {
						...
						res = 'rudeware.user: No passwd entry for user ' + loginArray[2] + '';
					}
					launchCommandAsVisitor({
				...
				if (vInput === "music play") {
					...
					launchCommandAsVisitor({
						cmd: vInput,
						res: '<div><p>[ <span class="red">rudeware</span> ] Usage: music [play/stop/link]</p></div>'
					});
				}
				...
				const OSVer = 'Arch Linux';
				const Kernel = 'x86_64 Linux 5.8.14-arch1-1';
				const Shell = 'bash 5.1.8';
				const Disk = '300G';
				launchCommandAsVisitor({
						cmd: $('input').val(),
						res: '<div><p><span class="red">visitor@rudeware.user</span><br><span class="red">OS:</span> '+OSVer+'<br><span class="red">Kernel:</span> ' + Kernel + '<br><span class="red">Uptime:</span> ' + upTime + '<br><span class="red">Shell:</span> ' + Shell + '<br><span class="red">Disk:</span> ' + Disk + '&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002</p></div>'
					});
			} else if (vInput.trim() !== "") {
		...
		if (root > 0) {
			launchCommandAsRoot({
				cmd: $('input').val(),
				res: '<div><p>rudeware.usert: ' + $('input').val() + ': command not found</p></div>'
			});
		} else {
			launchCommandAsVisitor({
				cmd: $('input').val(),
				res: '<div><p>rudeware.user: ' + $('input').val() + ': command not found</p></div>'
			});
		}
		if($('input').val() === 'clear') {
			$('#content > *').not(':last').remove();
